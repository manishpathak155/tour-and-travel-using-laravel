...
<section class="bg-white">
    <div class="mx-auto max-w-7xl px-6 py-16">
        ...
        <h1 class="text-4xl font-bold text-slate-900 md:text-5xl">Prepare for altitude, culture, and the unexpected.</h1>
    </div>
</section>
...
<section class="mx-auto max-w-7xl px-6 py-12">
    <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        ...
        @empty
            <p class="text-slate-500">No travel guides published yet.</p>
        @endforelse
    </div>
    <div class="mt-8">
        {{ $posts->links() }}
